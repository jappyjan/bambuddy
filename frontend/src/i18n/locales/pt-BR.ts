export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      detectorOpencv: 'Comparação de imagens',
      detectorAi: 'Modelo de visão com IA',
      detectorBadgeAi: 'IA',
      reason: 'Motivo',
      aiActiveTitle: 'A detecção por visão com IA está ativa',
      aiCalibrationNotApplicable: 'As imagens de referência e a área de detecção são usadas apenas pela comparação de imagens. Elas não têm efeito enquanto o modelo de visão com IA estiver selecionado.',
  ...
  fileManager: {
    ...
    deselectAll: 'Desmarcar tudo',
    selected: '{{count}} selecionado(s)',
    selectionOffscreen: '{{count}} fora desta visualização',
    notInThisView: 'fora desta visualização',
    selectAllInView: 'Selecionar tudo nesta visualização',
    clearAllSelected: 'Limpar seleção ({{count}})',
    filesToDelete: 'Estes arquivos serão excluídos:',
    adding: 'Adicionando...',
    loadingFiles: 'Carregando arquivos...',
  ...
  slicer: {
    ...
    nozzleHeading: 'Bico',
    nozzleDiameter: 'Diâmetro',
    nozzleDiameterSelect: 'Selecione um diâmetro',
    nozzleDiameterNone: 'Não especificado por este perfil',
    nozzleDiameterNoPrinter: 'Escolha uma impressora primeiro',
    nozzleDiameterUnavailable: '{{diameter}} mm — sem perfil',
    printerNoMatch: 'Nenhum perfil de impressora para {{model}} com bico de {{diameter}} mm. Escolha um diâmetro que esta impressora tenha.',
    printerNoMatchNoDiameter: 'Nenhum perfil de impressora para {{model}}.',
    filamentHeading: 'Filamento',
    addSlot: 'Adicionar um slot de filamento',
    removeSlot: 'Remover o último slot de filamento',
    filamentSlotPlain: 'Filamento {{index}}',
    filamentSlotAdded: 'Filamento {{index}} (adicionado)',
    slotMenu: 'Opções do filamento {{index}}',
    insertSlotAfter: 'Inserir um slot depois deste',
    removeThisSlot: 'Remover este slot',
    resetSlotColor: 'Restaurar a cor original do projeto',
    slotColor: 'Cor do filamento {{index}}',
    slotColorTitle: 'Cor do filamento {{index}} — clique para alterar',
    slotColorNotSet: 'Este slot ainda está com a cor definida no projeto.',
    slotLastRemaining: 'Um fatiamento precisa de pelo menos um slot de filamento.',
    slotOrderLocked: 'Este slot está pintado no modelo, que o identifica pelo número. Os slots seguintes podem ser adicionados e removidos.',
    slotOrderHint: 'Os slots que a sua mesa pinta mantêm a posição. Adicione e remova slots depois deles.',
    saveLayout: 'Salvar disposição',
    saveLayoutTitle: 'Salve esta organização: ela é aplicada sempre que este arquivo for fatiado.',
    saveLayoutClean: 'A mesa já corresponde à organização salva.',
    resetLayout: 'Redefinir disposição',
    resetLayoutTitle: 'Limpa a organização salva e devolve cada objeto ao estado original.',
    resetLayoutClean: 'A mesa já está na disposição original.',
    layoutArchiveUnsupported: 'As organizações só podem ser salvas para arquivos da biblioteca.',
    layoutSaved: 'Disposição salva',
    layoutReset: 'Disposição redefinida para a original',
    ...
    wizardReviewSummary: 'Suas escolhas — toque para alterar',
    wizardChipPrinter: 'Impressora',
    wizardChipFilaments: 'Filamentos',
    wizardChipSettings: 'Configurações',
    wizardChipNothingChosen: 'Nada escolhido ainda',
    wizardChipFilamentSlots: '{{chosen}} de {{total}} slots definidos',
    wizardBackToReview: 'Voltar à revisão',
  },
  ...
  notifications: {
    ...
    haServiceHint: 'Escolha um serviço do Home Assistant ou digite um se ele não estiver na lista.',
  ...
  plateDetection: {
    title: 'Detecção da mesa de impressão',
    description: 'Verifica a mesa logo após o início de uma impressão e pausa a impressão se ainda houver algo sobre ela. Ative por impressora na página de impressoras.',
    provider: 'Método de detecção',
    providerOpencv: 'Comparação de imagens (OpenCV)',
    providerAi: 'Modelo de visão com IA',
    providerHint: 'A comparação de imagens precisa de uma foto calibrada da mesa vazia e erra assim que a mesa é deslocada. O modelo de visão com IA envia uma captura da câmera para um endpoint compatível com OpenAI.',
    endpoint: 'URL base do endpoint',
    endpointHint: 'URL base de um servidor compatível com OpenAI, por exemplo https://api.openai.com/v1. O Bambuddy acrescenta /chat/completions.',
    model: 'Modelo',
    modelHint: 'Nome de um modelo capaz de ler imagens, por exemplo gpt-4o-mini.',
    apiKey: 'Chave de API',
    apiKeyHint: 'Enviada como token bearer. Deixe vazio para servidores locais que não exigem chave.',
    timeout: 'Tempo limite (segundos)',
    timeoutHint: 'A verificação ocorre enquanto a impressora já está imprimindo, então mantenha um valor curto. Se não houver resposta a tempo, a impressão continua.',
    envReadOnly: 'Valor definido pela variável de ambiente {{var}} (somente leitura)',
  },
