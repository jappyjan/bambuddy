export default {
  ...
  fileManager: {
    ...
    deselectAll: 'Deseleziona tutto',
    selected: '{{count}} selezionati',
    selectionOffscreen: '{{count}} non in questa vista',
    notInThisView: 'non in questa vista',
    selectAllInView: 'Seleziona tutto in questa vista',
    clearAllSelected: 'Cancella selezione ({{count}})',
    filesToDelete: 'Questi file verranno eliminati:',
    adding: 'Aggiunta...',
    loadingFiles: 'Caricamento file...',
  ...
  slicer: {
    ...
    nozzleDiameter: 'Diametro',
    nozzleDiameterSelect: 'Seleziona un diametro',
    nozzleDiameterNone: 'Non specificato da questo profilo',
    nozzleDiameterNoPrinter: 'Scegli prima una stampante',
    nozzleDiameterUnavailable: '{{diameter}} mm — nessun profilo',
    printerNoMatch: 'Nessun profilo stampante per {{model}} con ugello da {{diameter}} mm. Scegli un diametro disponibile per questa stampante.',
    printerNoMatchNoDiameter: 'Nessun profilo stampante per {{model}}.',
    filamentHeading: 'Filamento',
    addSlot: 'Aggiungi uno slot filamento',
    removeSlot: 'Rimuovi l’ultimo slot filamento',
    filamentSlotPlain: 'Filamento {{index}}',
    filamentSlotAdded: 'Filamento {{index}} (aggiunto)',
    slotMenu: 'Opzioni del filamento {{index}}',
    insertSlotAfter: 'Inserisci uno slot dopo questo',
    removeThisSlot: 'Rimuovi questo slot',
    resetSlotColor: 'Ripristina il colore originale',
    slotColor: 'Colore del filamento {{index}}',
    slotColorTitle: 'Colore del filamento {{index}}: fai clic per cambiarlo',
    slotColorNotSet: 'Questo slot ha ancora il colore con cui è stato progettato.',
    slotLastRemaining: 'Per affettare serve almeno uno slot filamento.',
    slotOrderLocked: 'Questo slot è dipinto nel modello, che lo identifica con il suo numero. Gli slot successivi si possono aggiungere e rimuovere.',
    slotOrderHint: 'Gli slot dipinti dal piatto mantengono la loro posizione. Aggiungi e rimuovi slot dopo di essi.',
    saveLayout: 'Salva disposizione',
    saveLayoutTitle: 'Salva questa disposizione: viene applicata a ogni slicing di questo file.',
    saveLayoutClean: 'Il piatto corrisponde già alla disposizione salvata.',
    resetLayout: 'Reimposta disposizione',
    resetLayoutTitle: 'Cancella la disposizione salvata e riporta ogni oggetto allo stato originale.',
    resetLayoutClean: 'Il piatto è già nella disposizione originale.',
    layoutArchiveUnsupported: 'Le disposizioni si possono salvare solo per i file della libreria.',
    layoutSaved: 'Disposizione salvata',
    layoutReset: 'Disposizione riportata all’originale',
    printNow: 'Stampa ora',
  ...
  notifications: {
    ...
    haServiceHint: 'Scegli un servizio da Home Assistant oppure digitane uno se non è elencato.',
