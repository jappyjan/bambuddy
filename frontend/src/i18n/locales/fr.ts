export default {
  ...
  fileManager: {
    ...
    deselectAll: 'Tout désélectionner',
    selected: '{{count}} sélectionnés',
    selectionOffscreen: '{{count}} hors de cette vue',
    notInThisView: 'hors de cette vue',
    selectAllInView: 'Tout sélectionner dans cette vue',
    clearAllSelected: 'Tout désélectionner ({{count}})',
    filesToDelete: 'Ces fichiers seront supprimés :',
    adding: 'Ajout...',
    loadingFiles: 'Chargement...',
  ...
  slicer: {
    ...
    nozzleHeading: 'Buse',
    nozzleDiameter: 'Diamètre',
    nozzleDiameterSelect: 'Choisir un diamètre',
    nozzleDiameterNone: 'Non précisé par ce profil',
    nozzleDiameterNoPrinter: 'Choisissez d’abord une imprimante',
    nozzleDiameterUnavailable: '{{diameter}} mm — aucun profil',
    printerNoMatch: 'Aucun profil d’imprimante pour {{model}} avec une buse de {{diameter}} mm. Choisissez un diamètre disponible pour cette imprimante.',
    printerNoMatchNoDiameter: 'Aucun profil d’imprimante pour {{model}}.',
    filamentHeading: 'Filament',
    addSlot: 'Ajouter un emplacement de filament',
    removeSlot: 'Supprimer le dernier emplacement de filament',
    filamentSlotPlain: 'Filament {{index}}',
    filamentSlotAdded: 'Filament {{index}} (ajouté)',
    slotMenu: 'Options du filament {{index}}',
    insertSlotAfter: 'Insérer un emplacement après celui-ci',
    removeThisSlot: 'Supprimer cet emplacement',
    resetSlotColor: 'Rétablir la couleur d’origine',
    slotColor: 'Couleur du filament {{index}}',
    slotColorTitle: 'Couleur du filament {{index}} — cliquez pour la changer',
    slotColorNotSet: 'Cet emplacement a encore la couleur prévue à la conception.',
    slotLastRemaining: 'Un découpage nécessite au moins un emplacement de filament.',
    slotOrderLocked: 'Cet emplacement est peint dans le modèle, qui le désigne par son numéro. Les emplacements suivants peuvent être ajoutés et supprimés.',
    slotOrderHint: 'Les emplacements peints par votre plateau gardent leur position. Ajoutez et supprimez des emplacements après eux.',
    saveLayout: 'Enregistrer la disposition',
    saveLayoutTitle: 'Enregistrer cet agencement : il est appliqué à chaque découpe de ce fichier.',
    saveLayoutClean: 'Le plateau correspond déjà à l’agencement enregistré.',
    resetLayout: 'Réinitialiser la disposition',
    resetLayoutTitle: 'Efface l’agencement enregistré et remet chaque objet dans son état d’origine.',
    resetLayoutClean: 'Le plateau est déjà dans sa disposition d’origine.',
    layoutArchiveUnsupported: 'Les agencements ne peuvent être enregistrés que pour les fichiers de la bibliothèque.',
    layoutSaved: 'Disposition enregistrée',
    layoutReset: 'Disposition réinitialisée à l’original',
