export default {
  ...
  fileManager: {
    ...
    deselectAll: 'Deselect All',
    selected: '{{count}} selected',
    selectionOffscreen: '{{count}} not in this view',
    notInThisView: 'not in this view',
    selectAllInView: 'Select All in View',
    clearAllSelected: 'Clear all {{count}}',
    filesToDelete: 'These files will be deleted:',
    adding: 'Adding...',
    loadingFiles: 'Loading files...',
  ...
  slicer: {
    ...
    resetLayout: 'Reset layout',
    resetLayoutTitle: 'Clear the saved arrangement and put every object back as designed.',
    resetLayoutClean: 'The plate is already in its original arrangement.',
    layoutArchiveUnsupported: 'Arrangements can only be saved for library files.',
    layoutSaved: 'Layout saved',
    layoutReset: 'Layout reset to the original arrangement',
    printNow: 'Print now',
  ...
  notifications: {
    ...
    haServiceHint: 'Pick a service from Home Assistant, or type one if it is not listed.',
    botToken: 'Bot Token',
    chatId: 'Chat ID',
