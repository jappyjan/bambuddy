export default {
  ...
  fileManager: {
    ...
    deselectAll: 'すべて選択解除',
    selected: '{{count}}件選択中',
    selectionOffscreen: 'このビューにない {{count}} 件',
    notInThisView: 'このビューにありません',
    selectAllInView: 'このビュー内をすべて選択',
    clearAllSelected: 'すべての選択を解除 ({{count}})',
    filesToDelete: '以下のファイルが削除されます:',
    adding: '追加中...',
    loadingFiles: 'ファイルを読み込み中...',
  ...
  slicer: {
    ...
    nozzleHeading: 'ノズル',
    nozzleDiameter: '直径',
    nozzleDiameterSelect: '直径を選択',
    nozzleDiameterNone: 'このプロファイルでは未指定',
    nozzleDiameterNoPrinter: '先にプリンターを選択してください',
    nozzleDiameterUnavailable: '{{diameter}} mm — プロファイルなし',
    printerNoMatch: '{{model}} と {{diameter}} mm ノズルの組み合わせに合うプリンタープロファイルがありません。このプリンターにある直径を選んでください。',
    printerNoMatchNoDiameter: '{{model}} に合うプリンタープロファイルがありません。',
    filamentHeading: 'フィラメント',
    addSlot: 'フィラメントスロットを追加',
    removeSlot: '最後のフィラメントスロットを削除',
    filamentSlotPlain: 'フィラメント {{index}}',
    filamentSlotAdded: 'フィラメント {{index}}（追加分）',
    slotMenu: 'フィラメント {{index}} の操作',
    insertSlotAfter: 'このすぐ後にスロットを挿入',
    removeThisSlot: 'このスロットを削除',
    resetSlotColor: '色を設計時の状態に戻す',
    slotColor: 'フィラメント {{index}} の色',
    slotColorTitle: 'フィラメント {{index}} の色 — クリックで変更',
    slotColorNotSet: 'このスロットは設計時の色のままです。',
    slotLastRemaining: 'スライスにはフィラメントスロットが少なくとも1つ必要です。',
    slotOrderLocked: 'このスロットはモデルに塗り分けられており、番号で参照されています。後ろのスロットは追加・削除できます。',
    slotOrderHint: 'プレートが塗り分けに使うスロットは位置が固定されます。その後ろのスロットは追加・削除できます。',
    saveLayout: '配置を保存',
    saveLayoutTitle: 'この配置を保存します。以降このファイルをスライスするたびに適用されます。',
    saveLayoutClean: 'プレートは保存済みの配置と同じです。',
    resetLayout: '配置をリセット',
    resetLayoutTitle: '保存した配置を削除し、すべてのオブジェクトを元の状態に戻します。',
    resetLayoutClean: 'プレートはすでに元の配置です。',
    layoutArchiveUnsupported: '配置を保存できるのはライブラリファイルだけです。',
    layoutSaved: '配置を保存しました',
    layoutReset: '配置を元に戻しました',
    printNow: 'すぐに印刷',
