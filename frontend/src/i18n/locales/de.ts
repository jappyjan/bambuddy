export default {
  ...
  fileManager: {
    ...
    deselectAll: 'Auswahl aufheben',
    selected: '{{count}} ausgewählt',
    selectionOffscreen: '{{count}} nicht in dieser Ansicht',
    notInThisView: 'nicht in dieser Ansicht',
    selectAllInView: 'Alle in dieser Ansicht auswählen',
    clearAllSelected: 'Alle {{count}} abwählen',
    filesToDelete: 'Diese Dateien werden gelöscht:',
    adding: 'Hinzufügen...',
    loadingFiles: 'Dateien werden geladen...',
    ...
    sliceCount: 'Slice-Ergebnisse: {{count}}',
    // Inspector panel (slicer UX redesign, spec §7 step 3).
    inspector: {
      slicePrint: 'Slicen & Drucken',
  ...
  slicer: {
    ...
    nozzleHeading: 'Düse',
    nozzleDiameter: 'Durchmesser',
    nozzleDiameterSelect: 'Durchmesser wählen',
    nozzleDiameterNone: 'In diesem Profil nicht angegeben',
    nozzleDiameterNoPrinter: 'Zuerst einen Drucker wählen',
    nozzleDiameterUnavailable: '{{diameter}} mm — kein Profil',
    printerNoMatch: 'Kein Druckerprofil für {{model}} mit {{diameter}} mm Düse. Wähle einen Durchmesser, den dieser Drucker hat.',
    printerNoMatchNoDiameter: 'Kein Druckerprofil für {{model}}.',
    filamentHeading: 'Filament',
    addSlot: 'Filamentplatz hinzufügen',
    removeSlot: 'Letzten Filamentplatz entfernen',
    filamentSlotPlain: 'Filament {{index}}',
    filamentSlotAdded: 'Filament {{index}} (hinzugefügt)',
    slotMenu: 'Optionen für Filament {{index}}',
    insertSlotAfter: 'Platz danach einfügen',
    removeThisSlot: 'Diesen Platz entfernen',
    resetSlotColor: 'Farbe auf Originalzustand zurücksetzen',
    slotColor: 'Farbe von Filament {{index}}',
    slotColorTitle: 'Farbe von Filament {{index}} — zum Ändern anklicken',
    slotColorNotSet: 'Dieser Platz hat noch die ursprünglich vorgesehene Farbe.',
    slotLastRemaining: 'Zum Slicen wird mindestens ein Filamentplatz benötigt.',
    slotOrderLocked: 'Dieser Platz ist im Modell eingefärbt, das ihn über seine Nummer anspricht. Plätze danach lassen sich hinzufügen und entfernen.',
    slotOrderHint: 'Plätze, die deine Platte einfärbt, behalten ihre Position. Plätze danach kannst du hinzufügen und entfernen.',
    saveLayout: 'Anordnung speichern',
    saveLayoutTitle: 'Diese Anordnung speichern – sie wird bei jedem Slicen dieser Datei angewendet.',
    saveLayoutClean: 'Die Platte entspricht bereits der gespeicherten Anordnung.',
    resetLayout: 'Anordnung zurücksetzen',
    resetLayoutTitle: 'Gespeicherte Anordnung löschen und alle Objekte in den Originalzustand zurücksetzen.',
    resetLayoutClean: 'Die Platte ist bereits in der ursprünglichen Anordnung.',
    layoutArchiveUnsupported: 'Anordnungen lassen sich nur für Bibliotheksdateien speichern.',
    layoutSaved: 'Anordnung gespeichert',
    layoutReset: 'Anordnung auf das Original zurückgesetzt',
