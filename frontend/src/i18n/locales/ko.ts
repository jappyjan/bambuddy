export default {
  ...
  fileManager: {
    ...
    selected: '{{count}}개 선택됨',
    selectionOffscreen: '이 보기에 없음 {{count}}개',
    notInThisView: '이 보기에 없음',
    selectAllInView: '이 보기에서 모두 선택',
    clearAllSelected: '전체 선택 해제 ({{count}})',
    filesToDelete: '다음 파일이 삭제됩니다:',
    adding: '추가 중...',
  ...
  slicer: {
    ...
    nozzleHeading: '노즐',
    nozzleDiameter: '직경',
    nozzleDiameterSelect: '직경 선택',
    nozzleDiameterNone: '이 프로파일에는 지정되지 않음',
    nozzleDiameterNoPrinter: '먼저 프린터를 선택하세요',
    nozzleDiameterUnavailable: '{{diameter}} mm — 프로파일 없음',
    printerNoMatch: '{{model}}의 {{diameter}} mm 노즐에 맞는 프린터 프로파일이 없습니다. 이 프린터에 있는 직경을 선택하세요.',
    printerNoMatchNoDiameter: '{{model}}에 맞는 프린터 프로파일이 없습니다.',
    filamentHeading: '필라멘트',
    addSlot: '필라멘트 슬롯 추가',
    removeSlot: '마지막 필라멘트 슬롯 제거',
    filamentSlotPlain: '필라멘트 {{index}}',
    filamentSlotAdded: '필라멘트 {{index}}(추가됨)',
    slotMenu: '필라멘트 {{index}} 옵션',
    insertSlotAfter: '이 뒤에 슬롯 삽입',
    removeThisSlot: '이 슬롯 제거',
    resetSlotColor: '설계 당시 색상으로 되돌리기',
    slotColor: '필라멘트 {{index}} 색상',
    slotColorTitle: '필라멘트 {{index}} 색상 — 클릭하여 변경',
    slotColorNotSet: '이 슬롯은 아직 설계 당시 색상 그대로입니다.',
    slotLastRemaining: '슬라이스하려면 필라멘트 슬롯이 최소 하나 필요합니다.',
    slotOrderLocked: '이 슬롯은 모델에 칠해져 있으며 모델이 번호로 참조합니다. 뒤쪽 슬롯은 추가하고 제거할 수 있습니다.',
    slotOrderHint: '플레이트가 칠하는 슬롯은 위치가 고정됩니다. 그 뒤의 슬롯은 추가하고 제거할 수 있습니다.',
    saveLayout: '배치 저장',
    saveLayoutTitle: '이 배치를 저장합니다. 이 파일을 슬라이스할 때마다 적용됩니다.',
    saveLayoutClean: '플레이트가 이미 저장된 배치와 같습니다.',
    resetLayout: '배치 초기화',
    resetLayoutTitle: '저장된 배치를 지우고 모든 오브젝트를 원래 상태로 되돌립니다.',
    resetLayoutClean: '플레이트가 이미 원래 배치입니다.',
    layoutArchiveUnsupported: '배치는 라이브러리 파일에만 저장할 수 있습니다.',
    layoutSaved: '배치를 저장했습니다',
    layoutReset: '배치를 원래대로 되돌렸습니다',
    printNow: '지금 인쇄',
