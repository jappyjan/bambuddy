export default {
  ...
  fileManager: {
    ...
    deselectAll: '取消全选',
    selected: '已选择 {{count}} 个',
    selectionOffscreen: '{{count}} 个不在当前视图',
    notInThisView: '不在当前视图',
    selectAllInView: '全选当前视图',
    clearAllSelected: '清除全部选择 ({{count}})',
    filesToDelete: '将删除以下文件：',
    adding: '添加中...',
    loadingFiles: '加载文件中...',
    folderIsEmpty: '文件夹为空',
    noFilesYet: '暂无文件',
  ...
  slicer: {
    ...
    nozzleHeading: '喷嘴',
    nozzleDiameter: '直径',
    nozzleDiameterSelect: '选择直径',
    nozzleDiameterNone: '此配置文件未指定',
    nozzleDiameterNoPrinter: '请先选择打印机',
    nozzleDiameterUnavailable: '{{diameter}} mm — 无配置文件',
    printerNoMatch: '没有适用于 {{model}} 且喷嘴为 {{diameter}} mm 的打印机配置文件。请选择该打印机拥有的直径。',
    printerNoMatchNoDiameter: '没有适用于 {{model}} 的打印机配置文件。',
    filamentHeading: '耗材',
    addSlot: '添加耗材槽位',
    removeSlot: '删除最后一个耗材槽位',
    filamentSlotPlain: '耗材 {{index}}',
    filamentSlotAdded: '耗材 {{index}}（新增）',
    slotMenu: '耗材 {{index}} 的操作',
    insertSlotAfter: '在此之后插入槽位',
    removeThisSlot: '删除此槽位',
    resetSlotColor: '恢复设计时的颜色',
    slotColor: '耗材 {{index}} 的颜色',
    slotColorTitle: '耗材 {{index}} 的颜色 — 点击可更改',
    slotColorNotSet: '此槽位仍使用设计时的颜色。',
    slotLastRemaining: '切片至少需要一个耗材槽位。',
    slotOrderLocked: '模型在此槽位上涂色，并按编号引用它。它之后的槽位可以添加和删除。',
    slotOrderHint: '盘面涂色用到的槽位位置固定。可在它们之后添加和删除槽位。',
    saveLayout: '保存布局',
    saveLayoutTitle: '保存该排布，之后每次切片该文件都会套用。',
    saveLayoutClean: '热床已与已保存的排布一致。',
    resetLayout: '重置布局',
    resetLayoutTitle: '清除已保存的排布，把所有模型恢复为原始状态。',
    resetLayoutClean: '热床已处于原始排布。',
    layoutArchiveUnsupported: '仅文件库中的文件可以保存排布。',
    layoutSaved: '布局已保存',
    layoutReset: '布局已恢复为原始排布',
    printNow: '立即打印',
  ...
  notifications: {
    ...
    haServiceHint: '从 Home Assistant 中选择一个服务，如果列表中没有，也可以直接输入。',
    botToken: '机器人令牌',
    chatId: '聊天 ID',
    smtpServer: 'SMTP 服务器',
    smtpPort: 'SMTP 端口',
