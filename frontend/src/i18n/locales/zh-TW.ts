export default {
  ...
  fileManager: {
    ...
    deselectAll: '取消全選',
    selected: '已選擇 {{count}} 個',
    selectionOffscreen: '{{count}} 個不在目前檢視',
    notInThisView: '不在目前檢視',
    selectAllInView: '全選目前檢視',
    clearAllSelected: '清除全部選取 ({{count}})',
    filesToDelete: '將刪除以下檔案：',
    adding: '新增中...',
    loadingFiles: '載入檔案中...',
    folderIsEmpty: '資料夾為空',
    noFilesYet: '尚無檔案',
  ...
  slice: {
    ...
    filamentTypeMismatch: '材料不符：此槽位需要 {{required}}，但 {{selected}} 是 {{selectedType}}。切片前請選擇 {{required}} 設定檔。',
    filamentTypeUnavailable: '找不到 {{required}} 設定檔 — 此選擇可能是錯誤的材料。切片前請檢查。',
    noPresetsForSlot: '無可用預設',
    noPresetsForPrinter: '沒有適用於此印表機的預設',
    otherPrinters: '其他印表機',
  ...
  slicer: {
    ...
    railLabel: '切片設定',
    presetsHeading: '設定檔',
    sectionPrinterQuality: '印表機與品質',
    printerModel: '印表機',
    printerModelSelect: '選擇印表機',
    nozzleHeading: '噴嘴',
    nozzleDiameter: '直徑',
    nozzleDiameterSelect: '選擇直徑',
    nozzleDiameterNone: '此設定檔未指定',
    nozzleDiameterNoPrinter: '請先選擇印表機',
    nozzleDiameterUnavailable: '{{diameter}} mm — 無設定檔',
    printerNoMatch: '沒有適用於 {{model}} 且噴嘴為 {{diameter}} mm 的印表機設定檔。請選擇此印表機擁有的直徑。',
    printerNoMatchNoDiameter: '沒有適用於 {{model}} 的印表機設定檔。',
    filamentHeading: '線材',
    addSlot: '新增線材槽位',
    removeSlot: '移除最後一個線材槽位',
    filamentSlotPlain: '線材 {{index}}',
    filamentSlotAdded: '線材 {{index}}（新增）',
    slotMenu: '線材 {{index}} 的選項',
    insertSlotAfter: '在此之後插入槽位',
    removeThisSlot: '移除此槽位',
    resetSlotColor: '還原為設計時的顏色',
    slotColor: '線材 {{index}} 的顏色',
    slotColorTitle: '線材 {{index}} 的顏色 — 點擊即可變更',
    slotColorNotSet: '此槽位仍是設計時的顏色。',
    slotLastRemaining: '切片至少需要一個線材槽位。',
    slotOrderLocked: '模型在此槽位上著色，並以編號參照它。其後的槽位可以新增與移除。',
    slotOrderHint: '列印板著色用到的槽位位置固定。可在它們之後新增與移除槽位。',
    saveLayout: '儲存排列',
    saveLayoutTitle: '儲存這個排列，之後每次切片這個檔案都會套用。',
    saveLayoutClean: '列印板已與已儲存的排列一致。',
    resetLayout: '重設排列',
    resetLayoutTitle: '清除已儲存的排列，把所有模型還原為原始狀態。',
    resetLayoutClean: '列印板已是原始排列。',
    layoutArchiveUnsupported: '只有檔案庫中的檔案可以儲存排列。',
    layoutSaved: '排列已儲存',
    layoutReset: '排列已還原為原始狀態',
    printNow: '立即列印',
