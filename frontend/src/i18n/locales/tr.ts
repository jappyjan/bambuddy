export default {
  ...
  fileManager: {
    ...
    deselectAll: 'Seçimi Kaldır',
    selected: '{{count}} seçildi',
    selectionOffscreen: 'Bu görünümde olmayan {{count}}',
    notInThisView: 'bu görünümde değil',
    selectAllInView: 'Bu görünümdekilerin tümünü seç',
    clearAllSelected: 'Seçimi temizle ({{count}})',
    filesToDelete: 'Bu dosyalar silinecek:',
    adding: 'Ekleniyor...',
    loadingFiles: 'Dosyalar yükleniyor...',
  ...
  slicer: {
    ...
    nozzleHeading: 'Nozul',
    nozzleDiameter: 'Çap',
    nozzleDiameterSelect: 'Bir çap seçin',
    nozzleDiameterNone: 'Bu profilde belirtilmemiş',
    nozzleDiameterNoPrinter: 'Önce bir yazıcı seçin',
    nozzleDiameterUnavailable: '{{diameter}} mm — profil yok',
    printerNoMatch: '{{model}} için {{diameter}} mm nozullu yazıcı profili yok. Bu yazıcıda bulunan bir çap seçin.',
    printerNoMatchNoDiameter: '{{model}} için yazıcı profili yok.',
    filamentHeading: 'Filament',
    addSlot: 'Filament yuvası ekle',
    removeSlot: 'Son filament yuvasını kaldır',
    filamentSlotPlain: 'Filament {{index}}',
    filamentSlotAdded: 'Filament {{index}} (eklendi)',
    slotMenu: 'Filament {{index}} seçenekleri',
    insertSlotAfter: 'Bunun ardına yuva ekle',
    removeThisSlot: 'Bu yuvayı kaldır',
    resetSlotColor: 'Rengi tasarımdaki haline döndür',
    slotColor: 'Filament {{index}} rengi',
    slotColorTitle: 'Filament {{index}} rengi — değiştirmek için tıklayın',
    slotColorNotSet: 'Bu yuva hâlâ tasarımdaki rengini taşıyor.',
    slotLastRemaining: 'Dilimleme için en az bir filament yuvası gerekir.',
    slotOrderLocked: 'Bu yuva modelde boyalı ve model ona numarasıyla başvuruyor. Sonrasındaki yuvalar eklenip kaldırılabilir.',
    slotOrderHint: 'Tablanızın boyadığı yuvalar konumunu korur. Onlardan sonraki yuvaları ekleyip kaldırabilirsiniz.',
    saveLayout: 'Yerleşimi kaydet',
    saveLayoutTitle: 'Bu yerleşimi kaydet — bu dosya her dilimlendiğinde uygulanır.',
    saveLayoutClean: 'Tabla zaten kaydedilmiş yerleşimle aynı.',
    resetLayout: 'Yerleşimi sıfırla',
    resetLayoutTitle: 'Kaydedilmiş yerleşimi siler ve tüm nesneleri özgün haline döndürür.',
    resetLayoutClean: 'Tabla zaten özgün yerleşiminde.',
    layoutArchiveUnsupported: 'Yerleşimler yalnızca kitaplık dosyaları için kaydedilebilir.',
    layoutSaved: 'Yerleşim kaydedildi',
    layoutReset: 'Yerleşim özgün haline sıfırlandı',
