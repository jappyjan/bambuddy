export default {
  ...
  fileManager: {
    ...
    deselectAll: 'Deseleccionar todo',
    selected: '{{count}} seleccionados',
    selectionOffscreen: '{{count}} fuera de esta vista',
    notInThisView: 'fuera de esta vista',
    selectAllInView: 'Seleccionar todo en esta vista',
    clearAllSelected: 'Borrar selección ({{count}})',
    filesToDelete: 'Se eliminarán estos archivos:',
    adding: 'Añadiendo...',
    loadingFiles: 'Cargando archivos...',
  ...
  slicer: {
    ...
    nozzleDiameter: 'Diámetro',
    nozzleDiameterSelect: 'Selecciona un diámetro',
    nozzleDiameterNone: 'No especificado por este perfil',
    nozzleDiameterNoPrinter: 'Elige primero una impresora',
    nozzleDiameterUnavailable: '{{diameter}} mm — sin perfil',
    printerNoMatch: 'No hay perfil de impresora para {{model}} con boquilla de {{diameter}} mm. Elige un diámetro que tenga esta impresora.',
    printerNoMatchNoDiameter: 'No hay perfil de impresora para {{model}}.',
    filamentHeading: 'Filamento',
    addSlot: 'Añadir una ranura de filamento',
    removeSlot: 'Quitar la última ranura de filamento',
    filamentSlotPlain: 'Filamento {{index}}',
    filamentSlotAdded: 'Filamento {{index}} (añadido)',
    slotMenu: 'Opciones del filamento {{index}}',
    insertSlotAfter: 'Insertar una ranura después de esta',
    removeThisSlot: 'Quitar esta ranura',
    resetSlotColor: 'Restablecer el color original',
    slotColor: 'Color del filamento {{index}}',
    slotColorTitle: 'Color del filamento {{index}}: haz clic para cambiarlo',
    slotColorNotSet: 'Esta ranura conserva el color con el que se diseñó.',
    slotLastRemaining: 'Un laminado necesita al menos una ranura de filamento.',
    slotOrderLocked: 'Esta ranura está pintada en el modelo, que la identifica por su número. Las ranuras posteriores sí se pueden añadir y quitar.',
    slotOrderHint: 'Las ranuras que pinta tu placa conservan su posición. Añade y quita ranuras después de ellas.',
    saveLayout: 'Guardar disposición',
    saveLayoutTitle: 'Guarda esta disposición: se aplica cada vez que se lamina este archivo.',
    saveLayoutClean: 'La placa ya coincide con la disposición guardada.',
    resetLayout: 'Restablecer disposición',
    resetLayoutTitle: 'Borra la disposición guardada y devuelve cada objeto a su estado original.',
    resetLayoutClean: 'La placa ya está en su disposición original.',
    layoutArchiveUnsupported: 'Las disposiciones solo se pueden guardar para archivos de la biblioteca.',
    layoutSaved: 'Disposición guardada',
    layoutReset: 'Disposición restablecida a la original',
    ...
    wizardReviewSummary: 'Tus opciones: toca para cambiarlas',
    wizardChipPrinter: 'Impresora',
    wizardChipFilaments: 'Filamentos',
    wizardChipSettings: 'Ajustes',
    wizardChipNothingChosen: 'Aún no has elegido nada',
    wizardChipFilamentSlots: '{{chosen}} de {{total}} ranuras definidas',
    wizardBackToReview: 'Volver al resumen',
  },
  ...
  notifications: {
    ...
    haServiceHint: 'Elige un servicio de Home Assistant o escribe uno si no aparece en la lista.',
